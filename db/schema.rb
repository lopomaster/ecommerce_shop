...
ActiveRecord::Schema.define(version: 2018_10_16_184908) do
  ...
  create_table "solidus_paypal_braintree_configurations", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "solidus_paypal_braintree_customers", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "user_id"
  ...
  create_table "solidus_paypal_braintree_sources", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "nonce"
    t.string "token"
